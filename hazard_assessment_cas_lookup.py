...
def process(CASlist):
    ...
    inventory = open("templates\Inventory.html",'w')
    ...
    Hlist = open('templates\Hazards.html','w')
    ...
    Plist = open('templates\Precautions.html','w')
    ...
    PPElist = open('templates\PPE.html','w')
    ...
    # Make a ZIP file with SDS folder
    zipf = zipfile.ZipFile('SDS.zip', 'w', zipfile.ZIP_DEFLATED)
    zipdir('SDS/', zipf)
    zipf.close()
